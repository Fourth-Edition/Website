...
export default function AboutClient() {
  ...
  return (
    <PageShell>
      ...
      {/* Philosophy & Values */}
      <section className="flex flex-col gap-6 md:gap-8" id="philosophy">
      ...
      {/* History & Timeline */}
      <section className="flex flex-col gap-6 md:gap-8" id="timeline">
        <div className="flex flex-col gap-3 max-w-3xl">
          <p
            className={`${isAr ? "font-bold text-xs" : geistMono.className} text-brand-navy text-xs md:text-sm font-semibold tracking-widest uppercase`}
          >
      ...
      {/* Team Nucleus */}
      <section className="flex flex-col gap-6 md:gap-8" id="team">
        <div className="flex flex-col gap-3 max-w-3xl">
          <p
            className={`${isAr ? "font-bold text-xs" : geistMono.className} text-brand-navy text-xs md:text-sm font-semibold tracking-widest uppercase`}
          >
